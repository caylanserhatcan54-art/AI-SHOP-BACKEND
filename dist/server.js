...
const qrText_1 = __importDefault(require("./routes/qrText"));
const qrImage_1 = __importDefault(require("./routes/qrImage"));
...
// QR TEXT ROUTE
app.use("/api/qr-text", qrText_1.default);
// QR IMAGE ROUTE
app.use("/api/qr-image", qrImage_1.default);
// PORT
