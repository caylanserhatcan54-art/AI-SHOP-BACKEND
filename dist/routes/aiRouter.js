...
-----------------------------------------------*/
async function analyzeQuestionWithGroq(userMessage) {
    var _a, _b, _c;
    try {
...
-----------------------------------------------*/
async function getFilteredProducts(shopId, filters) {
    ...
    for (const platformDoc of platformsSnap.docs) {
        ...
        productsSnap.forEach((p) => {
            ...
            let score = 0;
            if ((filters === null || filters === void 0 ? void 0 : filters.category) && text.includes(String(filters.category).toLowerCase())) {
                score += 3;
            }
            if ((filters === null || filters === void 0 ? void 0 : filters.subCategory) && text.includes(String(filters.subCategory).toLowerCase())) {
                score += 3;
            }
            if ((filters === null || filters === void 0 ? void 0 : filters.color) && text.includes(String(filters.color).toLowerCase())) {
                score += 2;
            }
            if ((filters === null || filters === void 0 ? void 0 : filters.occasion) && text.includes(String(filters.occasion).toLowerCase())) {
                score += 1;
            }
    ...
    const hasAnyFilter = (filters === null || filters === void 0 ? void 0 : filters.category) ||
        (filters === null || filters === void 0 ? void 0 : filters.subCategory) ||
        (filters === null || filters === void 0 ? void 0 : filters.color) ||
        (filters === null || filters === void 0 ? void 0 : filters.occasion) ||
        (filters === null || filters === void 0 ? void 0 : filters.gender);
    if (hasAnyFilter) {
...
-----------------------------------------------*/
async function generateSalesReply(products, messages) {
...
`;
    try {
        ...
        return (((_f = (_e = (_d = data === null || data === void 0 ? void 0 : data.choices) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.message) === null || _f === void 0 ? void 0 : _f.content) ||
...
exports.aiRouter.post("/chat", async (req, res) => {
    ...
    try {
        ...
        const userMessage = ((_a = messages[messages.length - 1]) === null || _a === void 0 ? void 0 : _a.content) || "";
