...
function detectIntent(msg: string): Intent {
  ...
  if (t.includes("fiyat")) return "ASK_PRICE";
  ...
  if (t.includes("nerede kullanılır") || t.includes("uygun mu")) return "ASK_SUITABILITY";
  if (t.includes("kombin") || t.includes("yakışır mı")) return "ASK_COMBINATION";
